...
5. Fit supporting parts before a boost kit. The server rejects incompatible installations without consuming the item. Removal is allowed. Essential combustion parts prevent running; absent cooling, oil or exhaust parts instead cause their relevant mechanical consequences.
...
| Exhaust / **Cast manifold** | Compact cast log; muffler is now a separate Service component. |
...
See [the component repair guide](PLAYING.md) for individual parts, fluids, instruments and diagnostic tools, and [the milestone report](mechanical-milestones.md) for current acceptance evidence and limits.
