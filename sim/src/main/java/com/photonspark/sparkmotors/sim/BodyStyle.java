...
public enum BodyStyle {
    ...
    HATCHBACK(1,"hatchback","Hatchback",2.190,1.940,.955,1.060,1.610,.775,.270,-1.340,-1.900,.040,0),
    SPORTS_CAR(2,"sports_car","Sports Coupe",2.330,2.160,.980,1.040,1.390,.775,.180,-.780,-1.440,-.025,-.090),
    SUV(3,"suv","Utility SUV",2.275,2.270,.995,1.240,1.880,.775,.300,-1.900,-2.230,.200,0),
    VAN(4,"van","Panel Van",2.185,2.570,1.010,1.390,2.170,.775,.440,-2.520,-2.530,.330,.090),
