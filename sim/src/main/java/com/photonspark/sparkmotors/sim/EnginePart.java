...
public enum EnginePart {
    ...
    public String description(int v){
        ...
        return switch(this){
            ...
            case COOLING -> new String[]{"Standard radiator and mechanical fan.","Thicker aluminium core; improved heat rejection.","Two electric fans improve cooling while stationary.","Large finned core and high-output fans for sustained boost."}[v-1];
            ...
            case EXHAUST -> new String[]{"Compact cast log and quiet muffler.","Paired runners improve low and medium RPM torque.","Individual equal-length pipes improve high RPM flow.","Large collector: strongest high RPM flow, less low-end torque."}[v-1];
