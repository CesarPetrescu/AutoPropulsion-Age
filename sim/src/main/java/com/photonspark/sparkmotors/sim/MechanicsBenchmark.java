...
public final class MechanicsBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String json=String.format(Locale.ROOT,"""
            {
              "scope": "Pure mechanical simulation only; excludes Minecraft entity, rendering and networking costs",
              "java": "%s",
    ...
    private static long[] run(int ticks){
        ...
        for(int c=0;c<CARS;c++){mechanics[c]=MechanicalState.legacy(Assembly.stock(),EnginePart.boosted(1),85,85,100);states[c]=new VehicleDynamics.State(0,0,1,40,0,0);}
