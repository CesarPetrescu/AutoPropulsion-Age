...
public enum Powertrain {
    ...
    HYBRID("Parallel hybrid", new BatteryModel.Spec(1.8, 220, .14, 200, 100, 45), 80, 220, 1460, 40, 0, 0),
    PLUG_IN_HYBRID("Plug-in parallel hybrid", new BatteryModel.Spec(18, 400, .11, 350, 100, 160), 120, 280, 1640, 55, 7.2, 30),
